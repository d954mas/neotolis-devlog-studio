...
BEATS: dict[str, Beat] = {
    ...
    "a1-1": Beat(
        ...
        chunks=[
            ...
            Chunk(words=(24, 29), kind="plate",
                  text="А ЧТО ЕСЛИ\nНЕТ ПРОБЛЕМЫ?",
                  size=160, subtitle="ДРУГОЙ УГОЛ", subtitle_color=_GOLD_DIM,
                  line_gap_ratio=0.10),
    ...
    "a1-2": Beat(
        ...
        chunks=[
            ...
            Chunk(words=(5, 9), kind="overlay",
                  text="РЕЛЬСЫ · КРУЖОЧКИ", subtitle="ПРИМИТИВЫ ДЛЯ ТЕСТА", position="bottom",
                  scene=Scene(kind="video", src="data/infographics/day1_progression_anim.mp4")),
    ...
    "b3": Beat(
        ...
        scene=Scene(kind="video", src="data/trailer/clean_gameplay_extended.mp4", offset=1.5),
        chunks=[
            ...
            Chunk(words=(30, 32), kind="overlay",
                  ...
                  scene=Scene(kind="video", src="data/itch/choice_mimes.mp4", offset=7.0)),
    ...
    "b4": Beat(
        ...
        chunks=[
            Chunk(words=(0, 3), kind="overlay",
                  ...
                  scene=Scene(kind="image", src="data/infographics/files_breakdown.png")),
    ...
    "a2-1": Beat(
        ...
        chunks=[
            ...
            Chunk(words=(17, 26), kind="plate",
                  ...
                  red_underline=True,
                  bg_image="data/itch/snap_city.png", bg_opacity=0.48),
    ...
    "a2-2": Beat(
        ...
        chunks=[
            ...
            Chunk(words=(43, 51), kind="plate",
                  ...
                  bg_image="data/itch/snap_suburbs.png", bg_opacity=0.20),
    ...
    "a2-4": Beat(
        ...
        chunks=[
            ...
            Chunk(words=(8, 27), kind="plate",
                  ...
                  sub_ratio=0.20, red_underline=True,
                  bg_image="data/itch/asset_sheet_promo.png", bg_opacity=0.30),
        ],
    ),
    ...
    "a2-5": Beat(
        ...
        chunks=[
            ...
            Chunk(words=(11, 16), kind="overlay",
                  ...
                  scene=Scene(kind="image", src="data/itch/snap_city.png")),
            ...
            Chunk(words=(32, 37), kind="overlay",
                  text="В STEAM ВЕРСИИ", subtitle="ВИЗУАЛ БУДЕТ НОРМАЛЬНЫМ", position="bottom",
